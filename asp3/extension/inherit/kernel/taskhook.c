 ...
 *  の責任を負わない．
 * 
 *  $Id: taskhook.c 1636 2022-09-23 10:08:01Z ertl-hiro $
 */
...
uint_t	(*mtxhook_calc_priority)(TCB *p_tcb) = NULL;
TCB *	(*mtxhook_change_priority)(TCB *p_tcb, uint_t oldpri,
											 uint_t *p_newpri) = NULL;
void	(*mtxhook_release_all)(TCB *p_tcb) = NULL;
void	(*mtxhook_dequeue_wobj)(TCB *p_tcb) = NULL;
