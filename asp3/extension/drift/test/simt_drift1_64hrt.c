 ...
 *  の責任を負わない．
 * 
 *  $Id: simt_drift1_64hrt.c 1437 2020-05-20 12:12:16Z ertl-hiro $
 */

/* 
 *		ドリフト調整機能のテスト(1)（USE_64BIT_HRTCNT版）
 *
 * 【テストの目的】
 *
